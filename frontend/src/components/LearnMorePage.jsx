        ...
        <div className="learnmore-page">
            ...
            <div className="lm-hero">
                ...
                <p className="lm-subtitle">
                    Understand how our AI-powered platform keeps you informed and in control of your health journey.
                </p>
            </div>
            ...
            <section className="lm-section">
                ...
                <div className="lm-steps">
                    <div className="lm-step">
                        ...
                        <p>Enter how you're feeling in plain language. Our AI understands natural, conversational descriptions — no medical jargon needed.</p>
                    </div>
                    <div className="lm-step">
                        <div className="lm-step-number">02</div>
                        <h3>AI Analyzes Your Input</h3>
                        <p>Powered by Claude and OpenAI, MedSy processes your input to surface relevant insights about your medications and symptoms.</p>
                    </div>
                    <div className="lm-step">
                        <div className="lm-step-number">03</div>
                        <h3>Understand Your Health</h3>
                        <p>Receive clear, actionable information about your symptoms and medications — translated from complex medical data into plain English.</p>
                    </div>
                </div>
            </section>
                ...
                <div className="lm-features-section-inner">
                    ...
                    <div className="lm-features-grid">
                        <div className="lm-feature-card">
                            ...
                            <p>Instantly look up any medication — side effects, dosage, interactions, and warnings explained in plain language.</p>
                        </div>
                        <div className="lm-feature-card">
                            <div className="lm-feature-icon">🤖</div>
                            <h3>AI Insights</h3>
                            <p>Get personalized health insights powered by the latest AI models from Anthropic Claude and OpenAI.</p>
                        </div>
                        <div className="lm-feature-card">
                            <div className="lm-feature-icon">📊</div>
                            <h3>Symptom Tracking</h3>
                            <p>Log symptoms over time and track patterns to share meaningful, organized data with your healthcare provider.</p>
                        </div>
                        <div className="lm-feature-card">
                            <div className="lm-feature-icon">🔒</div>
                            <h3>Private & Secure</h3>
                            <p>Your health data stays private. We never sell or share your personal information with third parties.</p>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className="lm-cta">
                ...
                <p className="lm-cta-desc">
                    Join MedSy and start understanding your medications like never before — completely free.
                </p>
                <button className="btn-primary btn-lg" onClick={() => navigate('/getstarted')}>
